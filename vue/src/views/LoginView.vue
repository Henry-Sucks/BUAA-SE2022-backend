<template>
  <div>
    ...
    <el-row>
      ...
      <el-col :span="6">
        ...
        <el-row>
          ...
          <el-input v-model='info.password' show-password clearable>
            <template #prefix>
    ...
    <el-row>
      <el-col :span="3"></el-col>
      <el-button class="button" color="#1F80B0" @click="handleLogin">登录</el-button>
      <el-button class="button" color="#1F80B0" @click="register">注册</el-button>
    </el-row>
  </div>
</template>
    ...
    handleLogin(){
        axios({
          ...
          if(response === 1)
            ...
            this.$store.commit('loginOptions/setUserInfo')
            }
          else if(response === -1)
            alert('密码输入不正确!')
          else  
