<template>
  <div>
    ...
    <el-row>
      ...
      <el-col :span="6">
        ...
        <el-row>
          ...
          <el-input v-model='info.userName'  clearable>
            <template #prefix>
        ...
        <el-row>
          ...
          <el-input v-model='info.email' placeholder="@"  clearable></el-input>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-input v-model='passwordAgain' show-password>
            <template #prefix>
              <el-icon class="el-input__icon"><lock /></el-icon>
            </template>
          </el-input>
    ...
    <el-row>
      <el-col :span="3"></el-col>
      <el-button @click="handleRegister"  class="button" color="#1F80B0">注册</el-button>
    </el-row>
  </div>
</template>
