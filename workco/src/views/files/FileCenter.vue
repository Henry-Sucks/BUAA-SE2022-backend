    ...
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="7">
          <el-button 
            color="#1F80B0" class="input new-button" round @click="createFile"
          >
            新建文档
          </el-button>
          </el-col>
          <el-col :span="8">
            <el-input v-model="searchInput" class="input" placeholder="通过文档名搜索文档">
                <template #prefix>
      ...
      <el-main>
        <el-row class="main">
            ...
            :data="data"
            :span="4">
            <team-card class="page-item" @click="enterFile(data.fid)"  :team="data"></team-card>
            </el-col>
        </el-row>
      </el-main>
      <el-footer>
